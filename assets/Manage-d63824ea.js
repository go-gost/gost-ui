...
}`,Fn={en:"Default",zh:"默认"},Mn={admissions:"https://gost.run/concepts/admission/",authers:"https://gost.run/concepts/auth/",bypasses:"https://gost.run/concepts/bypass/",chains:"https://gost.run/concepts/chain/",hops:"https://gost.run/concepts/hop/",hosts:"https://gost.run/concepts/hosts/",ingresses:"https://gost.run/concepts/ingress/",observers:"https://gost.run/concepts/observer/",resolvers:"https://gost.run/concepts/resolver/",limiters:"https://gost.run/concepts/limiter/",rlimiter:"https://gost.run/concepts/limiter/",climiter:"https://gost.run/concepts/limiter/",routers:"https://gost.run/concepts/router/",sds:"https://gost.run/concepts/sd/",services:"https://gost.run/concepts/service/"},Rn=[],Je=$n(dt,Rn,{allowTrailingComma:!0}),Dn=e=>{if(!Je)return;const n=Un(Je,[e,0]);if(n){const{offset:s,length:t}=n;return dt.substring(s,s+t)}},I=(e,n=Fn)=>{const s=Dn(e),t=Mn[e],l="// "+t+`
`;let o;return s&&(o={label:n,json:l+s}),{def:o,docUrl:t,_docUrl:l}},Pn=e=>`{
    "name": "${e}-0",
    "file": {
      "path": "/path/to/file"
    }
...
`:"";return[{label:"File",json:t+Pn(e)},{label:"Redis",json:t+Hn(e,s==null?void 0:s.redisType)},{label:"HTTP",json:t+Jn(e)},{label:"Plugin",json:t+ft(e)}]},{def:We,docUrl:Wn,_docUrl:qn}=I("admissions"),Gn=[We||{label:{zh:"内联",en:"Inline"},json:qn+`
      {
        "name": "admission-0",
        "matchers": [
          "127.0.0.1",
      ...
      }`},...J("admission",Wn)],{def:Qn,docUrl:Xn}=I("authers"),Zn=[Qn,...J("auther",Xn)],{def:Yn,docUrl:Qs,_docUrl:Kn}=I("chains"),Cn=[Yn,{label:{zh:"典型转发链",en:"Typical"},cli:"",json:Kn+`
{
  "name": "chain-0",
  "hops": [
    {
      ...
      `}],{def:qe,docUrl:es,_docUrl:ts}=I("bypasses"),ns=[qe||{label:{zh:"内联",en:"Inline"},json:ts+`
      {
        "name": "bypass-0",
        "matchers": [
          "127.0.0.1",
      ...
      }`},...J("bypass",es)],{def:Ge,docUrl:ss,_docUrl:ls}=I("hops"),rs=[Ge||{label:{zh:"内联",en:"Inline"},json:ls+`
    {
      "name": "hop-0",
      "nodes": [
        {
    ...
    }`},...J("hop",ss)],{def:Qe,docUrl:os,_docUrl:is}=I("hosts"),as=[Qe||{label:{zh:"内联",en:"Inline"},json:is+`
{
  "name": "hosts-0",
  "mappings": [
    {
    ...
    },
    {
...
}`},...J("hosts",os)],{def:Xe,docUrl:cs,_docUrl:us}=I("ingresses"),ds=[Xe||{label:{zh:"内联",en:"Inline"},json:us+`{
        "name": "ingress-0",
        "rules": [
          {
            "hostname": "example.com",
      ...
      }`},...J("ingress",cs,{redisType:"hash"})],{def:Ze,docUrl:fs,_docUrl:ms}=I("routers"),ps=[Ze||{label:{zh:"内联",en:"Inline"},json:ms+`
      {
        "name": "router-0",
        "routes": [
          {
      ...
      }`},...J("router",fs)],{def:hs,docUrl:Xs,_docUrl:he}=I("services"),D=(e,n,s)=>{let t=he+`
  {
    "name": "service-0",
    "addr": ":1080",
    "handler": {
    ...
    "listener": {
  ...
  }`;if(s){const l=pe(t,["metadata"],s,{});l.push(...pe(t,["handler","metadata"],s,{})),l.push(...pe(t,["listener","metadata"],s,{})),t=Be(t,l)}return t},gs=[hs,{label:{zh:"端口转发",en:"Port Forwarding"},cli:"-L tcp://:80/:8080",json:he+`
      {
        "name": "service-0",
        "addr": ":80",
        "handler": {
      ...
      }`},{label:{zh:"反向代理",en:"Reverse Proxy"},cli:"",json:he+`
      {
        "name": "service-0",
        "addr": ":80",
        "handler": {
      ...
      }`}],{def:Ye,docUrl:bs,_docUrl:ys}=I("climiter"),ks=[Ye||{label:{zh:"内联",en:"Inline"},json:ys+`
    {
      "name": "climiter-0",
      "limits": [
        "$ 1000",
    ...
    }`},...J("climiter",bs,{redisType:"set"})],{def:Ke,docUrl:js,_docUrl:ws}=I("limiters"),vs=[Ke||{label:{zh:"内联",en:"Inline"},json:ws+`
    {
      "name": "limiter-0",
      "limits": [
        "$ 100MB 100MB",
    ...
    }`},...J("limiters",js,{redisType:"set"})],{def:Ce,docUrl:xs,_docUrl:Ts}=I("rlimiter"),Os=[Ce||{label:{zh:"内联",en:"Inline"},json:Ts+`
    {
      "name": "rlimiter-0",
      "limits": [
        "$ 100",
    ...
    }`},...J("rlimiter",xs,{redisType:"set"})],{def:Ls,docUrl:Zs,_docUrl:As}=I("resolvers"),$s=[Ls,{label:"Plugin",json:As+ft("resolver")}],{def:et,docUrl:Ys,_docUrl:Us}=I("sds"),Ss=[et||{label:"HTTP Plugin",json:Us+`
      ...
      }`}],{def:tt,docUrl:Ks,_docUrl:_s}=I("observers"),Is=[tt||{label:"Plugin",json:_s+`
      {
        "name": "observer-0",
        "plugin": {
          "type": "grpc",
