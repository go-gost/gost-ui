...
}`,$n=[],Ue=jn(at,$n,{allowTrailingComma:!0}),Nn=e=>{if(!Ue)return;const s=wn(Ue,[e,0]);if(s){const{offset:n,length:t}=s;return at.substring(n,n+t)}},E=(e,s="默认")=>{const n=Nn(e);if(n)return{label:s,json:n}},En=e=>`{
    "name": "${e}-0",
    "file": {
      "path": "/path/to/file"
    }
...
`:"";return[{label:"文件",json:t+En(e)},{label:"Redis",json:t+In(e,n==null?void 0:n.redisType)},{label:"HTTP",json:t+Bn(e)},{label:"插件",json:t+ct(e)}]},De=E("admissions"),Fn=[De||{label:"内联",json:`
      ...
      }`},...W("admission","https://gost.run/concepts/admission")],He=E("authers"),_n=[He||{label:"内联",json:`
    ...
    }`},...W("auther","https://gost.run/concepts/auth")],zn=E("chains"),Mn=[zn,{label:"典型转发链",cli:"",json:`
{
  "name": "chain-0",
  "hops": [
    {
      ...
      `}],Je=E("bypasses"),Rn=[Je||{label:"内联",json:`
      ...
      }`},...W("bypass","https://gost.run/concepts/bypass/")],Pe=E("hops"),Un=[Pe||{label:"内联",json:`
    // https://gost.run/concepts/hop
    {
    ...
    }`},...W("hop","https://gost.run/concepts/hop")],We=E("hosts"),Dn=[We||{label:"内联",json:`
      ...
      }`},...W("hosts","https://gost.run/concepts/hosts/")],qe=E("ingresses"),Hn=[qe||{label:"内联",json:`{
        "name": "ingress-0",
        "rules": [
          {
            "hostname": "example.com",
      ...
      }`},...W("ingress","https://gost.run/concepts/ingress/",{redisType:"hash"})],Ge=E("routers"),Jn=[Ge||{label:"内联",json:`
      ...
      }`},...W("router","https://gost.run/concepts/router/")],D=(e,s,n)=>{let t=`
  {
    ...
    "listener": {
  ...
  }`;if(n){const l=fe(t,["metadata"],n,{});l.push(...fe(t,["handler","metadata"],n,{})),l.push(...fe(t,["listener","metadata"],n,{})),t=Ie(t,l)}return t},Pn=E("services"),Wn=[Pn,{label:"端口转发",cli:"-L tcp://:80/:8080",json:`
      {
        "name": "service-0", // 服务名称
        "addr": ":80",
        "handler": {
      ...
      }`}],Qe=E("climiter"),qn=[Qe||{label:"内联",json:`
    ...
    }`},...W("climiter","https://gost.run/concepts/limiter/",{redisType:"set"})],Xe=E("limiters"),Gn=[Xe||{label:"内联",json:`
    // https://gost.run/concepts/limiter/
    {
      "name": "limiter-0",
      "limits": [
    ...
    }`},...W("limiters","https://gost.run/concepts/limiter/",{redisType:"set"})],Ze=E("rlimiter"),Qn=[Ze||{label:"内联",json:`
    // https://gost.run/concepts/limiter/
    {
      "name": "rlimiter-0",
      "limits": [
    ...
    }`},...W("rlimiter","https://gost.run/concepts/limiter/",{redisType:"set"})],Xn=E("resolvers"),Zn=[Xn,{label:"插件",json:ct("resolver")}],Ye=E("sds"),Yn=[Ye||{label:"HTTP插件",json:`
      ...
      }`}],Ke=E("observers"),Kn=[Ke||{label:"插件",json:`
