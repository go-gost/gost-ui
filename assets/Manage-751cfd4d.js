...
`:"";return[{label:"File",json:t+ds(e)},{label:"Redis",json:t+fs(e,s==null?void 0:s.redisType)},{label:"HTTP",json:t+ms(e)},{label:"Plugin",json:t+_t(e)}]},{def:tt,docUrl:ps,_docUrl:hs}=P("admissions"),gs=[tt||{label:{zh:"内联",en:"Inline"},json:hs+`
      ...
      }`},...C("admission",ps)],{def:bs,docUrl:ys}=P("authers"),ks=[bs,...C("auther",ys)],{def:js,docUrl:vl,_docUrl:xs}=P("chains"),ws=[js,{label:{zh:"典型转发链",en:"Typical"},cli:"",json:xs+`
{
  "name": "chain-0",
  "hops": [
    {
      ...
      `}],{def:nt,docUrl:vs,_docUrl:Ls}=P("bypasses"),Ts=[nt||{label:{zh:"内联",en:"Inline"},json:Ls+`
      {
        "name": "bypass-0",
        "matchers": [
          "127.0.0.1",
      ...
      }`},...C("bypass",vs)],{def:st,docUrl:Os,_docUrl:As}=P("hops"),$s=[st||{label:{zh:"内联",en:"Inline"},json:As+`
    {
      "name": "hop-0",
      "nodes": [
        {
    ...
    }`},...C("hop",Os)],{def:lt,docUrl:Us,_docUrl:Ss}=P("hosts"),Es=[lt||{label:{zh:"内联",en:"Inline"},json:Ss+`
{
  ...
  "mappings": [
    ...
    },
    {
      ...
      }`},...C("router",Vs)],{def:Bs,docUrl:Ll,_docUrl:je}=P("services"),q=(e,n,s)=>{let t=je+`
  {
    "name": "service-0",
    "addr": ":1080",
    "handler": {
    ...
    "listener": {
      ...
      }`},{label:{zh:"代理服务",en:"Proxy Service"},children:[{label:"http",children:[{label:"http",json:q("http","tcp")},{label:"https(http+tls)",json:q("http","tls")},{label:"http+wss",json:q("http","wss")},{label:"http2",json:q("http2","http2")}]},{label:"relay",children:[{label:"relay+tcp",json:q("relay","tcp")},{label:"relay+tls",json:q("relay","tls")},{label:"relay+wss",json:q("relay","wss")},{label:"relay+mwss",json:q("relay","mwss")}]},{label:"socks",children:[{label:"socks4",json:q("socks","tcp")},{label:"socks5",json:q("socks5","tcp")},{label:"socks5(udp)",json:q("socks5","tcp",{udp:"true"})},{label:"socks5+tls",json:q("socks5","tls",{notls:"true"})}]}]},{label:{zh:"代理转发",en:"Porxy Forwarding"},cli:"-L socks5://:1080 -F socks5://xxx.com:1080",json:je+`
      {
        "name": "service-0",
        "addr": ":1080",
        "handler": {
